...
- [x] **Pass 2: Global Navigation & Footer.** Implement Site Header (with navigation & theme toggle) and Site Footer components.
...
- *Pass 2:* Built SiteHeader with brand name, inline navigation, and a Dark/Light ThemeToggle. Built SiteFooter with simple legal links. Adjusted Root Layout to correctly wrap page content between the header and footer.
