...
export const metadata: Metadata = buildMetadata({
  title: "Bankruptcy",
  description: "Bankruptcy consumer DNA test privacy policies.",
  path: "/compare",
})
    ...
    <div className="flex min-h-screen flex-col">
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
            buildBreadcrumbJsonLd([{ name: "Bankruptcy", url: "/compare" }]),
          ]),
        }}
      />
      <Header />
      <main className="section-padding flex-1 bg-background">
        <div className="container mx-auto px-4">
          <Breadcrumbs items={[{ name: "Bankruptcy", url: "/compare" }]} />
          <h1 className="text-h1">Bankruptcy Providers</h1>
